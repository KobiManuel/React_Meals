  ...
  return (
    ...
    >
      <div className=" max-w-[1100px] mx-auto flex flex-col gap-11">
        ...
        <div className=" w-full grid lg:grid-cols-3 md:grid-cols-2 body-font font-poppins gap-y-20 justify-center items-center">
          <div className=" flex flex-row text-white  justify-start pl-9 items-center gap-4">
