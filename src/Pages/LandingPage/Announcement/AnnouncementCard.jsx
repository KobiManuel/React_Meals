...
const AnnouncementCard = ({ image, top_text, bottom_text, position }) => {
  return (
    <div
      className={`${position} md:mt-0 self-center justify-self-center bg-white py-9 h-[400px] w-[274.66px] rounded-[2rem] flex flex-col justify-center items-center gap-4 px-2`}
    >
