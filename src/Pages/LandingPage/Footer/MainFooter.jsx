          ...
          <div className='pl-2 flex flex-col gap-6'>
            ...
            <div className='flex flex-row gap-5'>
             ...
             <div className='flex flex-col gap-8 h-full pl-12'>
                <div>
                    <p className='capitalize text-sm font-semibold text-white'>Company</p>
                </div>
             ...
             <div className='flex flex-col gap-8 h-full pl-12'>
                <div>
                    <p className='capitalize text-sm font-semibold text-white'>policy</p>
                </div>
                <ul  className=' text-stone-200 text-xs flex flex-col gap-3 leading-8'>
                    <li>FAQ</li>
                    <li>Contact</li>
             ...
             <div className='flex flex-col gap-8 h-full'>
                <div>
                    <p className='capitalize text-sm font-semibold text-white'>get in touch</p>
                </div>
                <ul  className=' text-stone-200 text-xs flex flex-col gap-3 leading-8'>
             ...
             <div className='flex flex-col gap-8 h-full'>
                <div>
                    <p className='capitalize text-sm font-semibold text-white'>Discover our app</p>
                </div>
            ...
            <div>
                ...
                <div class="text-[10px] font-semibold font-sans -mt-1">App Store</div>
            </div>
        </div>
